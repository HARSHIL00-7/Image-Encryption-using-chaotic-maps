...
def select_image2():
    ...
    label.place(x=0, y=0)
    dir_path = os.getcwd()
    file_path = os.path.join(dir_path, "filetobeencrypted.png")
    img.save(file_path)
    

select_button = Button(frame2, text="Select Encrypted Image", font=('Arial', 10), bg='#FFFFFF', fg='#000000', command=select_image2)
...
#DNA Encoding
Algo3Btn = Button(frame2, fg='black', text='Henon Map', bg='#1e85d0', font=("yu gothic ui bold", 15),
                   cursor='hand2', activebackground='#1e85d0',command=lambda:[show_frame(frame2),handle_login])
...
def show_decrypted_image():
    ...
    img = img.resize((300, 300), Image.ANTIALIAS)
    img = ImageTk.PhotoImage(img)
    label = Label(image_frame4, image=img)
    label.image = img
    label.place(x=0, y=0)
...
Algo1dBtn = Button(frame2, fg='black', text='Logistic Map', bg='#1e85d0', font=("yu gothic ui bold", 15),
                   cursor='hand2', activebackground='#1e85d0',command=show_decrypted_image )
...
#DNA Endo.
Algo3dBtn = Button(frame2, fg='black', text='Henon Map', bg='#1e85d0', font=("yu gothic ui bold", 15),
                   cursor='hand2', activebackground='#1e85d0',command=lambda:[show_frame(frame2),handle_login])
